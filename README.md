# Days 3 to 5: Least Recently Used (LRU) Cache
...
However, the trade off is the amount of space required to store the data. An LRU
...
The Node class has already been filled out. It contains four attributes: `data`,
